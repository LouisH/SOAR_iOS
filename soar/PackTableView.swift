...
class PackTableView : UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "openPackView", name: "showPackView", object: nil)
    ...
    func openPackView(){
        performSegueWithIdentifier("show_packview", sender: self)
        NSNotificationCenter.defaultCenter().postNotificationName("closeMenuViaNotification", object: nil)
    }
